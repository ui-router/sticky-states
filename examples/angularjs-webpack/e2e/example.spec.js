...
test.describe('example app', () => {
  ...
  test('home state has a textarea', async ({ page }) => {
    await page.goto('/');
    await expect(page.locator('[ui-view=home] textarea')).toBeVisible();
  });

  test('retains text entered into the textarea in home', async ({ page }) => {
    await page.goto('/');
    await page.locator('[ui-view=home] textarea').fill('Text entered here is not lost The quick brown fox');
    ...
    await expect(page.locator('[ui-view=home] textarea')).toHaveValue(
  ...
  test('retains text entered into the textarea in about', async ({ page }) => {
    ...
    await page.locator('[ui-view=about] textarea').fill('Text entered here is not lost The quack white duck');
    ...
    await expect(page.locator('[ui-view=about] textarea')).toHaveValue(
